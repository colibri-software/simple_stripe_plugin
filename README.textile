...
*If this plugin is used you should have SSL on your website. Colibri Software is not responsible for and breach in data. Use at your own risk.*
...
<pre><code><div id="registration">
  {% stripe_form_block submit_model: 'registrations' %}
    {% model_generator_fields 'registartions' reject_fields: "payment" %}
    <hr>
    {% stripe_fields name_label: "Name on Card", id_number_label: "Member Number" %}
  {% endstripe_form_block %}
</div></code></pre>
